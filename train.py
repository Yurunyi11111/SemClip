...
import torch
#torch.cuda.manual_seed(42212849)
...
class Trainer(DefaultTrainer):
    ...
    def build_optimizer(cls,cfg,model):
        ...
        for name,val in model.named_parameters():
            ...
            if val.requires_grad == True:
                print(name)
                if 'style_mean' in name or 'style_std' in name:
    ...
    def run_step(self):
        ...
        if len(self.off_opt_interval) and self.iter >= self.off_opt_interval[0] and self.iter < self.off_opt_interval[0]+self.off_opt_iters:
            ...
            loss_dict_s = self.model.opt_offsets(data_s,self.iter)
            opt_phase = True
        ...
        def do_test_st(flag):
            ...
            for dataset_name in self.cfg.DATASETS.TEST:
                ...
                if comm.is_main_process():
                    ...
                    storage.put_scalar(f'{dataset_name}_AP45', results_i['bbox']['AP45'],smoothing_hint=False)
